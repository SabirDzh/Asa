              ...
              children: [
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      Icon(
                        preview.isValid ? Iconsax.tick_circle : Iconsax.warning_2,
                        color: preview.isValid ? AppColors.primary : Colors.redAccent,
                        size: 24,
                      ),
                      ...
                      Expanded(
                        child: Text(
                          ...
                          style: TextStyle(
                            color: preview.isValid ? textColor : Colors.redAccent,
                    ...
                    Expanded(
                      child: ElevatedButton(
                        onPressed: preview.isValid
                            ? () async {
                                Navigator.pop(ctx);
                                final result = preview.snapshot == null
                                    ? const ImportResult(error: 'error_import_failed')
                        ...
                        style: ElevatedButton.styleFrom(
                          ...
                          disabledBackgroundColor: textSecondary.withValues(alpha: 0.2),
                          shape: RoundedRectangleBorder(
                            borderRadius: BorderRadius.circular(AppTheme.pillRadius),
                          ),
                        ),
